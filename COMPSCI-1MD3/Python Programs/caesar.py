def encrypt_letter(letter: str, key: int) -> str:
    """
    Encrypt letter by shifting its key places to the right and returning
...
def get_most_common(s: str)-> str:
    """
    Returns the char that occurs the most in s. If there is a tie, it will return
...
secret = 'ᘈᘜᘙᗔᘕᘢᘧᘫᘙᘦᗔᘨᘣᗔᘨᘜᘙᗔᘚᘝᘦᘧᘨᗔᘥᘩᘙᘧᘨᘝᘣᘢᗔᘣᘢᗔᘨᘜᘙᗔᘡᘝᘘᘨᘙᘦᘡᗔᘝᘧᗮᗔᘬᗔᗱᗔᗥᗥ'
