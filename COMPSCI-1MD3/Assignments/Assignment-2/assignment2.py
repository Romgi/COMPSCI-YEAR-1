...
def mirror(raw: List[List[List[int]]]) -> None:
    ...
    >>> mirror(raw)
    >>> raw == [[[255, 255, 255], [0, 0, 0], [233, 100, 115]],
...
def grey(raw: List[List[List[int]]]) -> None:
    ...
    ...        [[199, 201, 116], [1, 9, 0], [255, 255, 255]]]
    >>> grey(raw)
    >>> raw == [[[149, 149, 149], [0, 0, 0], [255, 255, 255]],
...
if __name__ == "__main__":
    # Run doctests with normalized whitespace and ellipsis enabled
    import doctest
