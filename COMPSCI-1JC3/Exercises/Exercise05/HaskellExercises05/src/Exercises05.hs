...
-- Exercise A
--------------------------------------------------------------------------------
-- Implement the function split that takes a list and splits it in half and
-- returns a tuple of the two halves, WITHOUT USING TAKE / DROP
--
-- NOTE when the list is uneven, the second list is one element larger than the
-- first NOTE^2 when using take / drop, although convenient, you introduce
--        redundant computation. A more efficient implementation of this
--        function can be done calling an auxilary function with different
--        parameters that recurses through the list directly
--------------------------------------------------------------------------------
split :: [a] -> ([a],[a])
split xs =
  let
...
-- Exercise B
--------------------------------------------------------------------------------
-- Implement the function merge that takes two lists that (assuming both lists
...
-- Exercise C
--------------------------------------------------------------------------------
-- Implement the function mergeSort that sorts a list by recusively splitting a
-- list, and merging the sorted lists back together
--
...
--
-- NOTE you can use this with QuickCheck to test your mergSort function by
...
-- Exercise F
--------------------------------------------------------------------------------
-- Implement the Prelude function !! that selects the nth element of a list
...
-- Exercise G
--------------------------------------------------------------------------------
-- Implement the Prelude function elem that takes a value and a list and returns
