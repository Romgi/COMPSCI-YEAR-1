...
-- Exercise A
--------------------------------------------------------------------------------
-- Implement a function that computes the nth fibanacci number (see
-- https://en.wikipedia.org/wiki/Fibonacci_number) NOTE if the input is less
-- than 0, simply return 0
--------------------------------------------------------------------------------
fib :: (Integral a) => a -> a
fib n
  | n <= 0 = 0
...
-- Exercise C
--------------------------------------------------------------------------------
-- Implement a function that multiples two numbers encoded using the following
-- Nat data type.
--
-- NOTE: start by creating a function add :: Nat -> Nat -> Nat
--------------------------------------------------------------------------------
...
-- Exercise D
--------------------------------------------------------------------------------
-- Implement a function that determines whether of not a given tree is a search
-- tree (is a "sorted" tree) 
--
-- NOTE: this means for every Node v t0 t1, v is >= all values in tree t0 and v
...
-- Exercise E
--------------------------------------------------------------------------------
-- Implement a function factors that takes an Int and returns a list off all its
-- factors (i.e. all the Int's bigger than 1 and less than that Int that are
-- divisable without a remainder).
--
...
-- Exercise F
--------------------------------------------------------------------------------
-- Implement a function pivot that takes a value and a list, then returns two
-- lists in a tuple, with the first list being all elements <= to the value, and
-- the second list being all elements > the value
--
-- i.e., pivot 3 [5,6,4,2,1,3] = ([2,1,3],[5,6,4])
--
